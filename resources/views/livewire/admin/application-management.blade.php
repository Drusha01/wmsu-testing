                            ...
                            <div class="container border border" id="cet-form">
                                <form wire:submit.prevent="cet_application()">
                                    <div @if($page == 2) class="d-none"@endif>
                                        <div class="row ">
                                            <div class="col-sm my-4 mx-2 d-flex align-items-center justify-content-center";>
                                            ...
                                            <div class="col-sm  my-4 mx-2  text-center py-5 mx-5">
                                                ...
                                                <p class="text-danger font-weight-bold">WMSU-CET APPLICATION FORM  <br> For School Year {{(date("Y")).' - '.(date("Y")+1)}}</p>
                                            </div>
