                    ...
                    <div class="col-lg-6 guide mt-5">
                        <div class="guide-section mt-5">
                            ...
                            <ul class="reminder-list">
                                ...
                                <li>Ensure that all information provided in the application form is accurate and up-to-date.</li>
                                <li>Double-check filling up the needed information</li>
                                <li>Prepare all necessary identification documents, pictures, etc.</li>
                                <li>If you have any questions or need assistance, please don't hesitate to contact our support team.</li>
                            </ul>
                        </div>
                    </div>
                </div>
