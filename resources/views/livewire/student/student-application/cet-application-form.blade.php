        ...
        @if($page == 1)
            <div>
                ...
                <div class="container border border-4 w-80">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text"  wire:model="cet_form.t_a_citizenship" class="form-control" required placeholder="Citizenship" >
                        </div>
                    </div>
                </div>
                <legend class="text-danger font-weight-bold">TYPE OF APPLICANT (CHECK ONE of the categories that applies to you):</legend>
                <select class="form-select form-select-lg mb-4" aria-label=".form-select-lg example" style="width: 380px; height: 50px; " wire:change="update_cet_type()" wire:model.defer="cet_form.t_a_cet_type_details">
                    ...
                    <div class="container border border-4 w-80">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="date" class="form-control" wire:model="cet_form.t_a_date_of_graduation" name="birthdate">
                            </div>
                            <div class="col-md-6 mb-2">
                    ...
                    <div class="container border border-4 w-80">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" id="last-name"  wire:model="cet_form.t_a_course" name="last_name" placeholder="Course" >
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="last-name" class="form-label">School Address </label>
                                <input type="text" class="form-control" id="last-name"  wire:model="cet_form.t_a_school_address" name="last_name" placeholder="School Address " required>
                ...
                <div align="end" class="py-4">
                    <button  style="width: 100px;" wire:click="page(2)" class="btn btn-primary">Next</a>
                </div>
            </div>
        @elseif($page ==2)
            <div class="container border border-4 w-80">
                <div class="text-danger font-weight-bold"> Course to take up:(Choose from the list of WMSU Campuses and Undergraduate degree programs/courses offered by WMSU posted in your school's bulletin board.)</div>
                    <div class="row px-2 py-3">
                        <div class="col-md-4">
                            <select class="form-select form-select-lg mb-4" aria-label=".form-select-lg example" style="width: 380px; height: 50px;" wire:model="cet_form.t_a_1st_choice">
                            ...
                            <select class="form-select form-select-lg mb-4" aria-label=".form-select-lg example" style="width: 380px; height: 50px; " wire:model="cet_form.t_a_3rd_choice">
                        ...
                        <div class="col-md-4">           
                            <select class="form-select form-select-lg mb-4" aria-label=".form-select-lg example" style="width: 380px; height: 50px; margin-left: 50px;" wire:model="cet_form.t_a_2nd_choice">
                ...
                <div class="text-danger font-weight-bold">Socio Econic Data: Furnish all required information. Under Column "Highest Education Finished" indicate the educational level actually completed (eg. Grade III, Third Year high school, High School Gradute, Second Year, College Graduate,etc) </div>
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example" style="width: 180px; height: 50px;" wire:model="cet_form.t_a_f_monthly_salary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-select" aria-label="Default select example" style="width: 180px; height: 50px;" wire:model="cet_form.t_a_m_monthly_salary">
                                        <option selected>Select</option>
                                        <option value="Below ₱5,000">Below ₱5,000</option>
                                        <option value="₱5,000 - ₱15,000">₱5,000 - ₱15,000</option>
                                        <option value="₱15,000 - ₱20,000">₱15,000 - ₱20,000 </option>
                    ...
                    <div class="text-danger font-weight-bold">
                        ...
                        <input type="checkbox" wire:model="cet_form.t_a_computer_literate" value="1" id="checkbox1"> <label for="checkbox1">Yes</label>
                    </div>
                    <div class="text-danger font-weight-bold">
