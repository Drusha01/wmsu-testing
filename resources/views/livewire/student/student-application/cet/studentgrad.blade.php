                                            ...
                                            <div class="form-container">
                                                <form wire:submit.prevent="submit_application()">
                                                    ...
                                                    <fieldset class="mb-2">
                                                        ...
                                                        <div class="border border-secondary">
                                                            <div class="row px-4 py-2">Original Senior High School Card
                                                                ...
                                                                <div class="col-md-12 mb-2 ">
                                                                    ...
                                                                    <input type="file" class="form-control" wire:model="t_a_original_senior_high_school_card" id="{{$t_a_original_senior_high_school_card_id}}" name="enrollment_certification" accept=".pdf,.jpg,.png,.jpeg" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </fieldset>
