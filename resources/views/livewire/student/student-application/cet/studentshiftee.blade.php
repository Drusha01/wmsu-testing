                                    ...
                                    <ul class="test-list">
                                        <li class="custom-dropdown" id="cetDropdownContainer">
                                            ...
                                            <ul class="dropdown-content" id="cetDropdown">
                                                ...
                                                <li><a href="{{ Route('student.cet.shiftee') }}">CET Shiftee/Transferee form</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                                        ...
                                                        <div class="border border-secondary ">
                                                            <div class=" row px-4 py-2 col-lg-12">
                                                                <div class=" mb-3 col-lg-15">
                                                                    <label for="high-school-name" class="form-label">School Name <span style="color:red;">*</span></label>
                                                                ...
                                                                <div class="col-lg-15 mb-3">
                                                                    <label for="high-school-address" class="form-label">School Address <span style="color:red;">*</span></label>
                                                        ...
                                                        <div class="border border-secondary">
                                                            <div class="row px-4 py-2">
                                                                <div class="col-md-12 mb-2">
                                                                    ...
                                                                    <input type="file" class="form-control" id="{{$t_a_formal_photo_id}}" wire:model="t_a_formal_photo" name="graduation_certification" accept=".pdf,.jpg,.png,.jpeg" >
                                                                </div>
                                                                <div class="col-md-6 mb-2 ">
                                                                    ...
                                                                    <input type="file" class="form-control" id="{{$t_a_transcript_of_records_id}}" wire:model="t_a_transcript_of_records" name="enrollment_certification" accept=".pdf,.jpg,.png,.jpeg" required>
                                                                </div>
                                                                <div class="col-md-6 mb-2 ">
