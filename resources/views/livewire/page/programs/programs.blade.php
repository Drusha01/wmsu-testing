                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6" >
                        ...
                        <img src="{{ asset('images/logo/agri.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <p class="card-text">teaches modern farming, crop cultivation, animal husbandry, and sustainable practices. Students gain agribusiness skills for diverse careers in agriculture, emphasizing innovation and sustainability...</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/arch.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.arch') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/islamic.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.islamic') }}" class="feature-link mt-4">Learn More <i
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/crim.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.crim') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/eng.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.engineering') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/forest.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.forestry') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/eco.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.economics') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/law.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.law') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/cla.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.cla') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/nursing.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.nursing') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/cpads.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.cpads') }}" class="feature-link ">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/sports.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.pe') }}" class="feature-link ">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2"style="height:400px;">
                        ...
                        <img src="{{ asset('images/logo/math.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.math') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2"style="height:400px;">
                        ...
                        <img src="{{ asset('images/logo/social.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.social') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2"style="height:400px;">
                        ...
                        <img src="{{ asset('images/logo/educ.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.educ') }}" class="feature-link mt-4">Learn More 
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
                        ...
                        <img src="{{ asset('images/logo/cs.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="{{ route('programs.comsci') }}" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
