                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/arch.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="services.php" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/islamic.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="registration.php" class="feature-link mt-4">Learn More <i
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/crim.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="about.php#community" class="feature-link mt-4">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        ...
                        <img src="{{ asset('images/logo/cpads.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="registration.php" class="feature-link ">Learn More <i
                                    class="bi bi-arrow-right-circle-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6"style="height:400px;">
                        ...
                        <img src="{{ asset('images/logo/educ.png') }}" width="50px" alt="wmsu logo">
                            ...
                            <a href="registration.php" class="feature-link mt-4">Learn More 
