...
<body>
<div class="container">
  <h2 class="mb-4">LSAT Application Form</h2>
  <form>
    <div class="row mb-3">
      <div class="col">
    ...
    <div class="mb-3">
      ...
      <div class="row">
        <div class="col">
          <input type="file" class="form-control" id="bachelorDegree" name="bachelorDegree" accept=".pdf,.doc,.docx" required>
    ...
    <div class="mb-3">
      ...
      <input type="file" class="form-control" id="barangayClearance" name="barangayClearance" accept=".pdf,.doc,.docx" required>
    </div>
    <div class="mb-3">
      <label class="form-label">Medical Certificate</label>
      <input type="file" class="form-control" id="medicalCertificate" name="medicalCertificate" accept=".pdf,.doc,.docx" required>
    </div>
